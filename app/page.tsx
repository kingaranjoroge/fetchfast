  ...
  return (
    <main className="flex flex-grow justify-center items-center flex-col relative overflow-hidden bg-homepage-background bg-cover bg-center bg-fixed">
      ...
      <div className='flex justify-center items-center flex-row z-10 gap-10 pt-10 px-10'>
        <Link href='/categories'><button className="btn btn-neutral bg-slate-900 text-white leading-5 py-0.5 sm:py-0 hover:bg-slate-100 hover:text-slate-900">View our Categories</button></Link>
        <Link href=''><button className="btn btn-neutral bg-slate-900 text-white leading-5 py-0.5 hover:bg-slate-100 hover:text-slate-900">Order product</button> </Link>               
      </div>      
    </main>
  );
}